...
creator_mnemonic = "fold rose thrive wall drift fantasy easily tool net gadget minor wait naive spread tired pluck drill debris physical harvest deny stage length ability hazard"
user_mnemonic = "child galaxy steak derive second autumn tag step slim monkey jaguar matrix cost toy gown grant helmet also toss swear lecture oxygen elephant about garden"
